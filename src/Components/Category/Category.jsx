    ...
    <div className="category-blok">
      ...
      <div className="category-right">
        ...
        <div className="category-box">
          {
          Array.from(new Array(8)).map(e => (
          <Link to="/productaboutpage" className="category-card">
            <div className="category-images">
              <img src={matras} alt="" className="category-img" />
            </div>
            <p className="category-text">Бязь- 001</p>
            <div className="category-titles">
              <p className="category-numbers">$1,3 <span>/m</span></p>
